...
exports.CreateSessionUseCase = (() => {
    ...
    let _classThis;
    var CreateSessionUseCase = _classThis = class {
        ...
        execute({ email, password }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const acessToken = (0, jsonwebtoken_1.sign)({}, auth_1.default.jwt.secret, {
                    subject: user.id,
    ...
    __setFunctionName(_classThis, "CreateSessionUseCase");
    (() => {
...
//# sourceMappingURL=CreateSessionUseCase.js.map